...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo SITE_URL; ?>/dashboard/balance.php" class="nav-item <?php echo $current_dir === 'dashboard' && $current_page === 'balance' ? 'active' : ''; ?>">
        ...
        <a href="<?php echo SITE_URL; ?>/dashboard/profile.php" class="nav-item <?php echo $current_dir === 'dashboard' && $current_page === 'profile' ? 'active' : ''; ?>">
